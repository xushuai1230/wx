...
Page({
  ...
  goToDetail: function (e) {
    ...
    wx.navigateTo({
      url: 'list/list?id=' + id + '&code=' + code + '&item=' + item + '&status=' + status + '&order=' + order + '&plannum=' + plannum,
    })
  },
  data: {
    hidden: true,
  ...
  scanCode: function () {
    ...
    wx.scanCode({
      ...
      success: (res) => {
        // console.log(res)
        wx.navigateTo({
          url: 'list/list?id=' + res.result + '&code=' + res.result,
        })
      }
    })
  },
