...
var GetNewList = function (that, mtype) {
  ...
  if (mtype == 'today') {
    json.Filter = "me.PlantAssResource=='" + that.data.code + "'&&ME.PlantBeginTime>=#" + GetToday() + "#&&ME.PlantBeginTime<#" + GetTomorrow() + "#&&me.DivisionType=='普通工作'&&me.Order.ERPState=='发放'";
    var json_child = {};
    ...
    json.Filter = "me.PlantAssResource=='" + that.data.code + "'&&ME.PlantBeginTime>=#" + GetTomorrow() + "#&&ME.PlantBeginTime<#" + GetAfterTomorrow() + "#&&me.DivisionType=='普通工作'&&me.Order.ERPState=='发放'";
    var json_child = {};
    ...
    json.Filter = "me.PlantAssResource=='" + that.data.code + "'&&ME.PlantBeginTime>=#" + GetAfterTomorrow() + "#&&ME.PlantBeginTime<#" + GetAfterNext() + "#&&me.DivisionType=='普通工作'&&me.Order.ERPState=='发放'";
    var json_child = {};
    json_child.PlantBeginTime = "ASC";
    json.SortCondition = json_child;
...
var GetList = function (that) {
  wx.request({
    ...
    success: function (res) {
      ...
      if (res.data.data.AvbResource=='否'){
        that.setData({
          ycword: '异常处理中...'
        })
      }
