Page({
  goToDetail: function (e) {
    ...
    wx.navigateTo({
      url: 'supply_detail/supply_detail?code=' + orderId,
    })
  },
  data: {
    hidden: true,
...
var GetList = function (that) {
  ...
  if (that.data.code == 'today') {
    json.Name = 'Supplier';
    json.Filter = "Digitate('me.Item.ExpandBSTR2')&&(me.Type=='采购订单'||me.Type=='预计入库')&&ME.PlanEndTime>=#" + GetToday() + "#&&ME.PlanEndTime<#" + GetTomorrow() + "#";
  } else if (that.data.code == 'tomorrow') {
    json.Name = 'Supplier';
    json.Filter = "Digitate('me.Item.ExpandBSTR2')&&(me.Type=='采购订单'||me.Type=='预计入库')&&ME.PlanEndTime>=#" + GetTomorrow() + "#&&ME.PlanEndTime<#" + GetAfterTomorrow() + "#";
  } else if (that.data.code == 'next') {
    json.Name = 'Supplier';
    json.Filter = "Digitate('me.Item.ExpandBSTR2')&&(me.Type=='采购订单'||me.Type=='预计入库')&&ME.PlanEndTime>=#" + GetAfterTomorrow() + "#&&ME.PlanEndTime<#" + GetAfterNext() + "#";
  } 
  console.info(json);
